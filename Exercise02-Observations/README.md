...
![Pipeline diagram showing the JSON to Parquet conversion activity for the Observations dataset writing to the processed ADLS container](https://user-images.githubusercontent.com/59613090/193125969-460256eb-b025-4e56-8e16-ad10677b54f2.png)
...
![Pipeline diagram showing the Spark Notebook activity that extracts and cleans Observations data and writes it back to ADLS](https://user-images.githubusercontent.com/59613090/193125858-14673041-4408-4afb-a0f2-3017de0c4550.png)
...
![Pipeline diagram showing the Script activity that creates the ObservationMain table in Dedicated SQL Pool](https://user-images.githubusercontent.com/59613090/193132332-12689085-0516-45ac-ab6d-ddd91ba3928d.png)


* We are now all setup with data ready to go and a table to load it in and we'll use a Copy Activity to perform the load.
![Pipeline diagram showing the Copy Activity that loads data into the ObservationMain table in Dedicated SQL Pool](https://user-images.githubusercontent.com/59613090/193132405-61afde90-c500-4097-8060-58bc00f0411e.png)
...
![Synapse Studio Integrate hub showing the observation folder expanded with the FHIR_Pipeline4Observation_Spark_OC pipeline selected](https://user-images.githubusercontent.com/59613090/193133194-68a05a70-e2c7-43b9-81fa-393b2050b231.png)
...
![Pipeline canvas with no activity selected, showing the Parameters tab in the bottom pane listing the five Observations pipeline-level parameters](https://user-images.githubusercontent.com/59613090/193143735-1d23e579-ba28-442e-94bb-e7f95c8c1be5.png)
...
![Debug button highlighted in the pipeline toolbar for the Observations pipeline in Synapse Studio](https://user-images.githubusercontent.com/59613090/193143925-bcab20eb-d2d1-4b40-81fd-b464d2ad90d2.png)
