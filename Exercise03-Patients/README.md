...
![Pipeline diagram showing the Data Flow Activity that extracts and cleans Patient data and writes it back to ADLS](https://user-images.githubusercontent.com/59613090/193136520-d0bcbab6-fc6f-4896-8ab4-19798833c384.png)
...
![Pipeline diagram showing the Script activity that creates the Patient Addresses and Patient Identifiers tables in Dedicated SQL Pool](https://user-images.githubusercontent.com/59613090/193136622-d84e952a-60f2-47f9-8895-717bf9e81c6b.png)


* We are now all setup with data ready to go and a table to load it in and we'll use a Copy Activity to perform the load.
![Pipeline diagram showing the Copy Activity that loads data into the Patient tables in Dedicated SQL Pool](https://user-images.githubusercontent.com/59613090/193144477-0a98c0d6-1f98-45b6-8e9a-42745960b837.png)
...
![Synapse Studio Integrate hub showing the patient folder expanded with the FHIR_Pipeline4Patient_DataFlow_OC pipeline selected](https://user-images.githubusercontent.com/59613090/193138455-cbb13596-0a2c-4353-808d-92958a7772f6.png)
...
![Pipeline canvas with no activity selected, showing the Parameters tab in the bottom pane listing the five Patient pipeline-level parameters](https://user-images.githubusercontent.com/59613090/193144874-eb863277-d90b-4f32-a208-6d8d8f2aff96.png)
...
![Debug options showing the Data Flow Debug radio button enabled and the Use Activity Runtime option selected from the dropdown](https://user-images.githubusercontent.com/59613090/193149525-ada67b9c-90b6-466e-bde7-5546f33fac56.png)
