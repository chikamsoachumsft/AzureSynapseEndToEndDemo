...
![Pipeline diagram showing the JSON to Parquet conversion activity that reads from the raw ADLS container and writes to the processed container](https://user-images.githubusercontent.com/59613090/193112535-e9c68b13-95e0-4463-a572-4cdc1b8d694d.png)
...
![Pipeline diagram showing the Synapse Spark Notebook activity that extracts, cleans, and writes Claims data back to ADLS](https://user-images.githubusercontent.com/59613090/193112711-8c6733f5-87e7-4639-a2e3-58afb6f2b414.png)
...
![Pipeline diagram showing the Script activity that creates the Diagnosis, Insurance, and Procedures tables in Dedicated SQL Pool](https://user-images.githubusercontent.com/59613090/193114025-309980e7-7c0a-415a-912b-fa8832c109ea.png)
...
![Pipeline diagram showing three parallel Copy Activities loading Diagnosis, Insurance, and Procedures tables in Dedicated SQL Pool](https://user-images.githubusercontent.com/59613090/193114655-add929b4-a317-49b5-8a48-014a5e15ddaa.png)
...
![Pipeline diagram showing the Spark Notebook activity that creates serverless SQL metadata tables on top of the data lake](https://user-images.githubusercontent.com/59613090/193118363-04c00d81-a374-4113-9a97-e3d3f3994807.png)
...
![Synapse Studio Integrate hub showing the Claims folder expanded with the FHIR_Pipeline4Claim_Spark_OC pipeline selected](https://user-images.githubusercontent.com/59613090/192874762-8647fe4e-23c5-4430-b0c1-d557812de371.png)
...
![Pipeline canvas with no activity selected, showing the Parameters tab in the bottom pane listing the five pipeline-level parameters](https://user-images.githubusercontent.com/59613090/192875386-3f5eb80a-1920-40b7-aefc-483b4b5853d4.png)
...
![Debug button highlighted in the pipeline toolbar for the Claims pipeline in Synapse Studio](https://user-images.githubusercontent.com/59613090/192880611-b693730c-4b2d-4145-b5af-931f6a808050.png)
